...
const CancelOrderScreen = ({navigation, route}) => {
 ...
 const handleConfirmCancel = async () => {
    try {
      setLoading(true)
      await axiosInstance.put(`order/${order._id}/cancel`, {
        reason: selectedReasons + (customReason ? `: ${customReason}` : '')
      });
         navigation.navigate('CancelConfirmScreen');
      // handleRefreshOrders();
    } catch (error) {
      Toast(error?.response?.data?.error)
  console.log("Failed to cancel order:", error.response.data);
    }finally{
      setLoading(false)
    }
  };
      ...
      <View style={styles.cardHeader}>
        <View style={styles.vendorContainer}>
          ...
          <Text style={styles.vendorName}>
            {order?.pickupAddresses[0]?.name || 'Unknown Vendor'}
          </Text>
        </View>
      ...
      <TouchableOpacity
        ...
        <View style={styles.shippingInfo}>
          ...
          <View style={styles.shippingDetails}>
            <Text style={styles.shippingStatus}>{order.orderStatus}</Text>
            <Text style={styles.deliveryEstimate}>
              Estimated delivery charge ₹40
            </Text>
          </View>
        </View>
      </TouchableOpacity>
  ...
  return (
    <SafeAreaView style={styles.container}>
      <KeyboardAvoidingView
        ...
        keyboardVerticalOffset={30} // adjust this depending on your header/nav
      >
        <View style={{flex: 1}}>
      ...
      /> */}
          ...
          <ScrollView
            ...
            <Text style={styles.label}>
              Please let us know the reason for cancelling this product
            </Text>
            ...
            <View style={styles.buttonContainer}>
              <TouchableOpacity
                style={[
                  ...
                  !selectedReasons.length && {opacity: 0.5},
                ]}
